...
1. Go to the [Releases](../../releases) page and download two files: `MusicAssistant_1.1.0.0_x64.msix` and `MusicAssistant-TestSigning.cer`.
...
3. Double-click `MusicAssistant_1.1.0.0_x64.msix` and click **Install**.
